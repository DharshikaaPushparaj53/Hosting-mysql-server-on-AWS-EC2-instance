...
code: **CREATE DATABASE mysql_test;** (this will create a database inside the MySQL server)
      **USE mysql_test;**
      **CREATE TABLE table1(id INT, name VARCHAR(45));** (this will create a table inside the mysql_test database. INT and VARCHAR are the data types for numbers and strings, respectively)
      **INSERT INTO table1 VALUES(1, 'Virat'), (2, 'Sachin'), (3, 'Dhoni'), (4, 'ABD');** (Assigning values to the table)
...
Finally, check the table by selecting the created table.
      **SELECT *from table1;** (Viewing all the rows and columns in table1)
